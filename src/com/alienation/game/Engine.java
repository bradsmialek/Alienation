...
public class Engine {
    ...
    public static void ResumeOrNewGame(Boolean isDead){
        if(!isDead) {
    ...
    public static Map<Rooms, List<String>> getAvailableItemsMap() {
        if(availableItemsMap.size() == 0) {
            ...
            availableItemsMap.put(Rooms.ControlRoom, new ArrayList<String>(Arrays.asList("Monitor", "Control Panel", "Pilot Seats", "Laser")));
        }
